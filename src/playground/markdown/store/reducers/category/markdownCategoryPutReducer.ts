...
import { IMarkdownCategoryPut } from 'playground/markdown/classes/queries';
...
const initialState: IQuerySingleState<IMarkdownCategoryPut, IMarkdownCategory> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQuerySingleState<IMarkdownCategoryPut, IMarkdownCategory>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as markdownCategoryPutReducer };