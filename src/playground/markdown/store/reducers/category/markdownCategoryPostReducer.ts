...
import { IMarkdownCategoryPost } from 'playground/markdown/classes/queries';
...
const initialState: IQuerySingleState<IMarkdownCategoryPost, IMarkdownCategory> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQuerySingleState<IMarkdownCategoryPost, IMarkdownCategory>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as markdownCategoryPostReducer };