...
const Test = reduxForm<TestFormData>({
    ...
    class Test extends React.Component<TestProps> {
        public handleSubmitForm = (values: Partial<TestFormData>, dispatch: Dispatch<any>, props: {}) => {};
...
class HandleSubmitTest extends React.Component {
    public handleSubmit = (values: Partial<TestFormData>, dispatch: Dispatch<any>, props: {}) => {};
    public render() {
