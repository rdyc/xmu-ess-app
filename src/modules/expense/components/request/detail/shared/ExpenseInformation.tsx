...
export const expenseInformation: React.SFC<AllProps> = props => {
  ...
  const render = (
    <Card square>
      <CardHeader 
        title={props.intl.formatMessage(expenseMessages.request.section.title)}
        subheader={props.intl.formatMessage(expenseMessages.request.section.subTitle)}
      />
      <CardContent>
        <TextField
        ...
        <TextField
          {...GlobalStyle.TextField.ReadOnly}
          label={props.intl.formatMessage(expenseMessages.request.field.createdBy)}
