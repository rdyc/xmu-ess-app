import { IExpenseRequestGetByIdRequest } from '@expense/classes/queries/request';
...
const initialState: IQuerySingleState<IExpenseRequestGetByIdRequest, IExpenseDetail> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQuerySingleState<IExpenseRequestGetByIdRequest, IExpenseDetail>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as expenseRequestGetByIdReducer };