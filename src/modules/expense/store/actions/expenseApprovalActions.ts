...
export const expenseApprovalGetAllError = (message: string) => action(ExpenseApprovalAction.APPROVAL_GET_ALL_ERROR, message);
...
export const expenseApprovalGetByIdError = (message: string) => action(ExpenseApprovalAction.APPROVAL_GET_BY_ID_ERROR, message);
...
export const expenseApprovalPostError = (message: string) => action(ExpenseApprovalAction.APPROVAL_POST_ERROR, message);
