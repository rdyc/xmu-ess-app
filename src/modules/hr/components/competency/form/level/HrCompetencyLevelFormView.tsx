...
import { HrCompetencyLevelFormProps, ILevelFormValue } from './HrCompetencyLevelForm';
import HrCompetencyLevelPartial from './HrCompetencyLevelPartial';

export const HrCompetencyLevelFormView: React.SFC<HrCompetencyLevelFormProps> = props => (
  <FormPage
    info={{
  ...
  >
    <Formik
      ...
      render={(formikBag: FormikProps<ILevelFormValue>) => (
        <Form>
          <div className={props.classes.flexRow}>
            <div className={props.classes.flexColumn}>
              <div className={props.classes.flexContent}>
                <HrCompetencyLevelPartial 
