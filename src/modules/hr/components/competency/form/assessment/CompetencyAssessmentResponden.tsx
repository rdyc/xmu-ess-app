...
// type CompetencyAssessmentRespondenProps = {
//   formMode: FormMode; 
...
// const CompetencyAssessmentResponden: React.ComponentType<CompetencyAssessmentRespondenProps> = props => (
//   <Card square>
//     <CardHeader 
//       title={props.intl.formatMessage(hrMessage.competency.field.type, {state: 'Assessment Responden'})}
//       subheader={
//         props.formikBag.submitCount > 0 &&
//         typeof props.formikBag.errors.responden === 'string' &&
//         props.formikBag.errors.responden
//       }
...
//           <React.Fragment>
//             {
//               props.formikBag.values.responden.length > 0 &&
//               <CardContent>
//                 <List disablePadding>
//                 {
//                   props.formikBag.values.responden.length > 0 &&
//                   props.formikBag.values.responden.map((item, index) => 
//                     <Field
//                       key={index}
//                       name={`responden.${index}.employeeUid`}
//                       render={({ field, form }: FieldProps<ICompetencyAssessmentFormValue>) => {
//                         const error = getIn(form.errors, `responden.${index}.employeeUid`);
//                         const touch = getIn(form.touched, `responden.${index}.employeeUid`);
...
//                                       // prevent duplicate
//                                       if (value !== '') {
//                                         const isExist = props.formikBag.values.responden.findIndex(responden => responden.employeeUid === value);
...
// export default CompetencyAssessmentResponden;