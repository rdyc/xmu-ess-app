...
import { HrCompetencyMappedFilterProps } from './HrCompetencyMappedFilter';

export const HrCompetencyMappedFilterView: React.SFC<HrCompetencyMappedFilterProps> = props => (
  <React.Fragment>
    <Dialog
      fullScreen
