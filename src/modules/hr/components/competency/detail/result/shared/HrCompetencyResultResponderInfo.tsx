...
// const hrCompetencyResultResponderInfo: React.SFC<AllProps> = props => {
...
//                     !item.isExpired && !item.isDraft && item.statusType !== WorkflowStatusType.Submitted ? props.classes.avatarSecondary 
...
// export const HrCompetencyResultResponderInfo = compose<AllProps, IOwnProps>(
//   injectIntl,
//   withStyles(styles),
//   withStateHandlers(createProps, stateUpdaters)
// )(hrCompetencyResultResponderInfo);