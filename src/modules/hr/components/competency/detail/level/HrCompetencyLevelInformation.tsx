...
// interface OwnProps {
//   data: IHrCompetencyLevelDetail;
// }

// type AllProps = OwnProps & InjectedIntlProps;

// const hrCompetencyLevelInformation: React.SFC<AllProps> = props => {
...
//           margin="dense"
//           label={intl.formatMessage(hrMessage.competency.field.uid, {state: 'Level'})}
//           value={data.uid}
//         />
//         <TextField
//           {...GlobalStyle.TextField.ReadOnly}
...
// export const HrCompetencyLevelInformation = compose<AllProps,  OwnProps>(
//   injectIntl
// )(hrCompetencyLevelInformation);