...
const hrCompetencyCategoryInformation: React.SFC<AllProps> = props => {
...
export const HrCompetencyCategoryInformation = compose<AllProps,  OwnProps>(
  injectIntl
)(hrCompetencyCategoryInformation);