...
const hrCompetencyAssessmentInformation: React.SFC<AllProps> = props => {
    ...
    <Card square>
      ...
      <CardContent>
        ...
        <TextField
          ...
          value={data.position.company && data.position.company.name}
        />
        <TextField
          {...GlobalStyle.TextField.ReadOnly}
          margin="dense"
...
export const HrCompetencyAssessmentInformation = compose<AllProps,  OwnProps>(
  injectIntl
)(hrCompetencyAssessmentInformation);