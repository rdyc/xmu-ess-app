...
const hrCornerCategorySummary: React.SFC<AllProps> = props => (
  <Grid container>
    ...
    <Grid item xs={12} sm={6} md={3}>
      <TextField
        multiline
        {...GlobalStyle.TextField.ReadOnly}
        label={props.intl.formatMessage(hrMessage.corner.field.slug)}
...
export const HrCornerCategorySummary = compose<AllProps, OwnProps>(
  injectIntl
)(hrCornerCategorySummary);