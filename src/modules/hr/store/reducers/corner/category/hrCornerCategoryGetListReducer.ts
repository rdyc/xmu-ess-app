...
import { IHrCornerCategoryGetListRequest } from '@hr/classes/queries';
import { IHrCornerCategoryList } from '@hr/classes/response';
import { HrCornerCategoryAction as Action } from '@hr/store/actions';
import { Reducer } from 'redux';

const initialState: IQueryCollectionState<IHrCornerCategoryGetListRequest, IHrCornerCategoryList> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQueryCollectionState<IHrCornerCategoryGetListRequest, IHrCornerCategoryList>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as hrCornerCategoryGetListReducer };