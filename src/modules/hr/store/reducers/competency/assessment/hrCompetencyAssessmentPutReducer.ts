...
import { IHrCompetencyAssessmentPutRequest } from '@hr/classes/queries';
...
const initialState: IQuerySingleState<IHrCompetencyAssessmentPutRequest, IHrCompetencyAssessment> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQuerySingleState<IHrCompetencyAssessmentPutRequest, IHrCompetencyAssessment>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as hrCompetencyAssessmentPutReducer };