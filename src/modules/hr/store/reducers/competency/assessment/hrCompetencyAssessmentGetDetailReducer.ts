...
import { IHrCompetencyAssessmentGetDetailRequest } from '@hr/classes/queries';
...
const initialState: IQuerySingleState<IHrCompetencyAssessmentGetDetailRequest, IHrCompetencyAssessmentDetail> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQuerySingleState<IHrCompetencyAssessmentGetDetailRequest, IHrCompetencyAssessmentDetail>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as hrCompetencyAssessmentGetDetailReducer };