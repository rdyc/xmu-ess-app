...
import { IHrCompetencyAssessmentGetAllRequest } from '@hr/classes/queries';
...
const initialState: IQueryCollectionState<IHrCompetencyAssessmentGetAllRequest, IHrCompetencyAssessment> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQueryCollectionState<IHrCompetencyAssessmentGetAllRequest, IHrCompetencyAssessment>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as hrCompetencyAssessmentGetAllReducer };