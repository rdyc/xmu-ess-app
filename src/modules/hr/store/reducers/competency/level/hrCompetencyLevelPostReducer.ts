...
import { IHrCompetencyLevelPostRequest } from '@hr/classes/queries';
import { IHrCompetencyLevel } from '@hr/classes/response';
import { HrCompetencyLevelAction as Action } from '@hr/store/actions';
import { Reducer } from 'redux';

const initialState: IQuerySingleState<IHrCompetencyLevelPostRequest, IHrCompetencyLevel> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQuerySingleState<IHrCompetencyLevelPostRequest, IHrCompetencyLevel>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as hrCompetencyLevelPostReducer };