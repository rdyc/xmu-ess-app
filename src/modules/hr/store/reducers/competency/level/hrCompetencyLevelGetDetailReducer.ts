...
import { IHrCompetencyLevelGetDetailRequest } from '@hr/classes/queries';
...
const initialState: IQuerySingleState<IHrCompetencyLevelGetDetailRequest, IHrCompetencyLevelDetail> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQuerySingleState<IHrCompetencyLevelGetDetailRequest, IHrCompetencyLevelDetail>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as hrCompetencyLevelGetDetailReducer };