...
import { IHrCompetencyCategoryPostRequest } from '@hr/classes/queries';
...
const initialState: IQuerySingleState<IHrCompetencyCategoryPostRequest, IHrCompetencyCategory> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQuerySingleState<IHrCompetencyCategoryPostRequest, IHrCompetencyCategory>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as hrCompetencyCategoryPostReducer };