...
import { IHrCompetencyCategoryGetListRequest } from '@hr/classes/queries';
...
const initialState: IQueryCollectionState<IHrCompetencyCategoryGetListRequest, IHrCompetencyCategoryList> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQueryCollectionState<IHrCompetencyCategoryGetListRequest, IHrCompetencyCategoryList>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as hrCompetencyCategoryGetListReducer };