...
import { IHrCompetencyCategoryGetDetailRequest } from '@hr/classes/queries';
...
const initialState: IQuerySingleState<IHrCompetencyCategoryGetDetailRequest, IHrCompetencyCategoryDetail> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQuerySingleState<IHrCompetencyCategoryGetDetailRequest, IHrCompetencyCategoryDetail>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as hrCompetencyCategoryGetDetailReducer };