...
import { IHrCompetencyCategoryGetAllRequest } from '@hr/classes/queries';
...
const initialState: IQueryCollectionState<IHrCompetencyCategoryGetAllRequest, IHrCompetencyCategory> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQueryCollectionState<IHrCompetencyCategoryGetAllRequest, IHrCompetencyCategory>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as hrCompetencyCategoryGetAllReducer };