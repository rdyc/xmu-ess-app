...
import { IHrCompetencyEmployeeGetAllRequest } from '@hr/classes/queries';
...
const initialState: IQueryCollectionState<IHrCompetencyEmployeeGetAllRequest, IHrCompetencyEmployee> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQueryCollectionState<IHrCompetencyEmployeeGetAllRequest, IHrCompetencyEmployee>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as hrCompetencyEmployeeGetAllReducer };