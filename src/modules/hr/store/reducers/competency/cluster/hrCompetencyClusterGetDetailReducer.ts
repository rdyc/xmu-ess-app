...
import { IHrCompetencyClusterGetDetailRequest } from '@hr/classes/queries';
...
const initialState: IQuerySingleState<IHrCompetencyClusterGetDetailRequest, IHrCompetencyClusterDetail> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQuerySingleState<IHrCompetencyClusterGetDetailRequest, IHrCompetencyClusterDetail>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as hrCompetencyClusterGetDetailReducer };