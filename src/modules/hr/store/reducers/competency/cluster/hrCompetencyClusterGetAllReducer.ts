...
import { IHrCompetencyClusterGetAllRequest } from '@hr/classes/queries';
...
const initialState: IQueryCollectionState<IHrCompetencyClusterGetAllRequest, IHrCompetencyCluster> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQueryCollectionState<IHrCompetencyClusterGetAllRequest, IHrCompetencyCluster>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as hrCompetencyClusterGetAllReducer };