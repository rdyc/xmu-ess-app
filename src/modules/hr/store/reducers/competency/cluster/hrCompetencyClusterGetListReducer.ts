...
import { IHrCompetencyClusterGetListRequest } from '@hr/classes/queries';
...
const initialState: IQueryCollectionState<IHrCompetencyClusterGetListRequest, IHrCompetencyClusterList> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQueryCollectionState<IHrCompetencyClusterGetListRequest, IHrCompetencyClusterList>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as hrCompetencyClusterGetListReducer };