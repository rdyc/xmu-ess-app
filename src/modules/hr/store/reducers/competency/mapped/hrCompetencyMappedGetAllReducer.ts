...
import { IHrCompetencyMappedGetAllRequest } from '@hr/classes/queries';
import { IHrCompetencyMapped } from '@hr/classes/response';
import { HrCompetencyMappedAction as Action } from '@hr/store/actions';
import { Reducer } from 'redux';

const initialState: IQueryCollectionState<IHrCompetencyMappedGetAllRequest, IHrCompetencyMapped> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQueryCollectionState<IHrCompetencyMappedGetAllRequest, IHrCompetencyMapped>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as hrCompetencyMappedGetAllReducer };