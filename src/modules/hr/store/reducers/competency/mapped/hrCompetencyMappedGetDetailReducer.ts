...
import { IHrCompetencyMappedGetDetailRequest } from '@hr/classes/queries';
...
const initialState: IQuerySingleState<IHrCompetencyMappedGetDetailRequest, IHrCompetencyMappedDetail> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQuerySingleState<IHrCompetencyMappedGetDetailRequest, IHrCompetencyMappedDetail>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as hrCompetencyMappedGetDetailReducer };