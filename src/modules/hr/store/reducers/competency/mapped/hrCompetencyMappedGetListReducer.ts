...
import { IHrCompetencyMappedGetListRequest } from '@hr/classes/queries';
...
const initialState: IQueryCollectionState<IHrCompetencyMappedGetListRequest, IHrCompetencyMappedList> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQueryCollectionState<IHrCompetencyMappedGetListRequest, IHrCompetencyMappedList>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as hrCompetencyMappedGetListReducer };