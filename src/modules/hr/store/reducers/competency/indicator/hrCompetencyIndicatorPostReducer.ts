...
import { IHrCompetencyIndicatorPostRequest } from '@hr/classes/queries';
...
const initialState: IQuerySingleState<IHrCompetencyIndicatorPostRequest, IHrCompetencyIndicator> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQuerySingleState<IHrCompetencyIndicatorPostRequest, IHrCompetencyIndicator>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as hrCompetencyIndicatorPostReducer };