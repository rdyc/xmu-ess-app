...
import { IHrCompetencyIndicatorGetDetailRequest } from '@hr/classes/queries';
...
const initialState: IQuerySingleState<IHrCompetencyIndicatorGetDetailRequest, IHrCompetencyIndicatorDetail> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQuerySingleState<IHrCompetencyIndicatorGetDetailRequest, IHrCompetencyIndicatorDetail>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as hrCompetencyIndicatorGetDetailReducer };