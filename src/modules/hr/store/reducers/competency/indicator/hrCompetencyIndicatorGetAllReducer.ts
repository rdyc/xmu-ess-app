...
import { IHrCompetencyIndicatorGetAllRequest } from '@hr/classes/queries';
...
const initialState: IQueryCollectionState<IHrCompetencyIndicatorGetAllRequest, IHrCompetencyIndicator> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQueryCollectionState<IHrCompetencyIndicatorGetAllRequest, IHrCompetencyIndicator>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as hrCompetencyIndicatorGetAllReducer };