...
export const organizationHierarchyGetAllError = (message: string) => action(OrganizationHierarchyAction.GET_ALL_ERROR, message);
...
export const organizationHierarchyGetListError = (message: string) => action(OrganizationHierarchyAction.GET_LIST_ERROR, message);
...
export const organizationHierarchyGetByIdError = (message: string) => action(OrganizationHierarchyAction.GET_BY_ID_ERROR, message);
...
export const organizationHierarchyPostError = (message: string) => action(OrganizationHierarchyAction.POST_ERROR, message);
...
export const organizationHierarchyPutError = (message: string) => action(OrganizationHierarchyAction.PUT_ERROR, message);
...
export const organizationHierarchyDeleteError = (message: string) => action(OrganizationHierarchyAction.DELETE_ERROR, message);
