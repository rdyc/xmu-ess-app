...
const stateUpdaters: StateUpdaters<AllProps, IOwnState, IOwnStateUpdater> = {
  ...
  setConfig: (state: IOwnState) => (config: IListConfig<IHierarchy>): Partial<IOwnState> => ({
    config
  }),
  setFilterVisibility: (state: IOwnState) => (): Partial<IOwnState> => ({
    isFilterOpen: !state.isFilterOpen
  }),
  setFilterApplied: (state: IOwnState) => (filter: IOrganizationHierarchyListFilterResult): Partial<IOwnState> => ({
    ...filter,
    isFilterOpen: false
  }),
};
