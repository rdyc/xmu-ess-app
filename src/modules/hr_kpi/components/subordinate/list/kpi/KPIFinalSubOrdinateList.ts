...
import { KPIAssignSubOrdinateListView } from './KPIFinalSubOrdinateListView';
...
export type KPIFinalSubOrdinateListProps 
  = IOwnOption
...
const createProps: mapper<KPIFinalSubOrdinateListProps, IOwnState> = (): IOwnState => {
  // default state
...
const stateUpdaters: StateUpdaters<KPIFinalSubOrdinateListProps, IOwnState, IOwnStateUpdater> = {
};

const handlerCreators: HandleCreators<KPIFinalSubOrdinateListProps, IOwnHandler> = {
  handleOnLoadApi: (props: KPIFinalSubOrdinateListProps) => (params?: IBasePagingFilter, resetPage?: boolean, isRetry?: boolean) => {
  ...
  handleOnLoadApiSearch: (props: KPIFinalSubOrdinateListProps) => (find?: string, findBy?: string) => {
  ...
  handleOnBind: (props: KPIFinalSubOrdinateListProps) => (item: IKPIFinal, index: number) => ({
    key: index,
...
const lifecycles: ReactLifeCycleFunctions<KPIFinalSubOrdinateListProps, IOwnState> = {
  componentDidUpdate() {
    // 
  }
};

export const KPIFinalSubOrdinateList = compose(
  setDisplayName('KPIFinalSubOrdinateList'),
  withUser,
  withAccountEmployeeKPIFinal,
  withRouter,
  injectIntl,
