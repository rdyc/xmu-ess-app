...
import { KPIFinalSummary } from '@kpi/components/final/detail/shared/KPIFinalSummary';
import { kpiMessage } from '@kpi/locales/messages/kpiMessage';
import { KPIFinalSubOrdinateListProps } from './KPIFinalSubOrdinateList';

export const KPIAssignSubOrdinateListView: React.SFC<KPIFinalSubOrdinateListProps> = props => (
  <React.Fragment>
    <CollectionPage 
      // page info
      info={{
      ...
      actionComponent={(item: IKPIFinal) => (
        <React.Fragment>
           <Button 
            size="small"
            color="secondary"
            onClick={() => props.history.push(`/kpi/subordinates/${item.employeeUid}/${item.uid}`)}
          >
