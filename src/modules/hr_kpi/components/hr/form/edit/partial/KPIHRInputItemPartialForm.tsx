...
import { IKPIEmployeeFormValue, IKPIEmployeeItemFormValue } from '../KPIHRInputForm';
import KPIHRInputSingleItemPartialForm from './KPIHRInputSingleItemPartialForm';
                  ...
                  <React.Fragment>
                    {
                      ...
                      <Tooltip key={index} title={props.intl.formatMessage(kpiMessage.measurement.field.tooltip)}>
                        <TableRow key={index}>
                          ...
                          <TableCell numeric onClick={() => props.formikBag.setFieldValue(`items.${index}.isOpen`, true)}>
                            {props.intl.formatNumber(props.formikBag.values.items[index].achieved)}
                          </TableCell>
                          <TableCell numeric onClick={() => props.formikBag.setFieldValue(`items.${index}.isOpen`, true)}>
                          ...
                          <KPIHRInputSingleItemPartialForm
