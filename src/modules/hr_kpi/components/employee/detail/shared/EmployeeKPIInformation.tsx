...
interface OwnProps {
  data: IEmployeeKPIDetail;
}
type AllProps
  = OwnProps
  & InjectedIntlProps;

const employeeKPIInformation: React.SFC<AllProps> = props => {
  const render = (
    <Card square>
      <CardHeader
...
export const EmployeeKPIInformation = compose<AllProps, OwnProps>(injectIntl)(employeeKPIInformation);