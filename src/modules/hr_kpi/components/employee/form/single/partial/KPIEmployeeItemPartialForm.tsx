                      ...
                      <TableCell>
                        <Field
                          ...
                          render={({ form }: FieldProps<IKPIEmployeeFormValue>) => {
                            ...
                            return (
                              <KPICategoryOption filter={props.filterKPICategory} defaultLabel={props.intl.formatMessage(kpiMessage.employee.field.categoryUidPlaceholder)}>
                                <SelectField
                                  isSearchable
                                  menuPlacement="auto"
                                  menuPosition="fixed"
                      ...
                      <TableCell>
                        <Field
                          ...
                          render={({ form }: FieldProps<IKPIEmployeeFormValue>) => {
                            ...
                            return (
                              <KPIMeasurementOption filter={props.filterKPIMeasurement} categoryUid={props.formikBag.values.items[index].categoryUid} defaultLabel={props.intl.formatMessage(kpiMessage.employee.field.measurementUidPlaceholder)}>
                                <SelectField
                                  isSearchable
                                  menuPlacement="auto"
                                  menuPosition="fixed"
                                  ...
                                  onChange={(selected: ISelectFieldOption) => {
                                    ...
                                    props.formikBag.setFieldValue(`items.${index}.measurementDescription`, selected && selected.label || '');
                                  }}
                                />
