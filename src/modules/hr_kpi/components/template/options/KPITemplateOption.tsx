...
interface IOwnOption {
  filter?: IKPITemplateGetListFilter;
}
...
const stateUpdaters: StateUpdaters<KPITemplateOptionProps, IOwnState, IOwnStateUpdater> = {
...
const component: React.SFC<KPITemplateOptionProps> = props => {
