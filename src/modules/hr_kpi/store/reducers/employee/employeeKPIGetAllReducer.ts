...
const initialState: IQueryCollectionState<IEmployeeKPIGetAllRequest, IEmployeeKPI> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQueryCollectionState<IEmployeeKPIGetAllRequest, IEmployeeKPI>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as employeeKPIGetAllReducer };