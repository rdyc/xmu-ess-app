...
const initialState: IQueryCollectionState<IKPIEmployeePostRequest, IKPIEmployee> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQueryCollectionState<IKPIEmployeePostRequest, IKPIEmployee>> = (state = initialState, action) => {
  switch (action.type) {
