...
import { IKPICategoryGetDetailRequest } from '@kpi/classes/queries/category';
...
const initialState: IQuerySingleState<IKPICategoryGetDetailRequest, IKPICategoryDetail> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQuerySingleState<IKPICategoryGetDetailRequest, IKPICategoryDetail>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as kpiCategoryGetByIdReducer };