...
import { ProjectApprovalListFilterProps } from './ProjectApprovalListFilter';

export const ProjectApprovalListFilterView: React.SFC<ProjectApprovalListFilterProps> = props => (
  <React.Fragment>
    <Dialog
      fullScreen
    ...
    >
      ...
      <DialogContent className={props.classes.paddingDisabled}>
        <List>
          ...
          <ListItem>
            <ListItemText 
              primary={props.intl.formatMessage(projectMessage.registration.field.isNotify)}
    ...
    <LookupSystemDialog
      ...
      category="status"
      moduleType={ModuleDefinitionType.ProjectRegistration}
      hideBackdrop={true}
