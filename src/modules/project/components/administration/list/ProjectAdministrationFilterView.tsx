...
import { ProjectAdministrationListFilterProps } from './ProjectAdministrationFilter';

export const ProjectAdministrationListFilterView: React.SFC<ProjectAdministrationListFilterProps> = props => (
  <React.Fragment>
    <Dialog
      fullScreen
