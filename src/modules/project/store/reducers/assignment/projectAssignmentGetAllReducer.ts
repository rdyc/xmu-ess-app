...
import { IProjectAssignmentGetAllRequest } from '@project/classes/queries/assignment';
...
const initialState: IQueryCollectionState<IProjectAssignmentGetAllRequest, IProjectAssignment> = {
  request: undefined,
  response: undefined,
  isError: false,
  isLoading: false,
...
const reducer: Reducer<IQueryCollectionState<IProjectAssignmentGetAllRequest, IProjectAssignment>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as projectAssignmentGetAllReducer };