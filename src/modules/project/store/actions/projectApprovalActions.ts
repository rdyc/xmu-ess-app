...
export const projectApprovalGetAllError = (error: any) => action(ProjectApprovalAction.GET_ALL_ERROR, error);
...
export const projectApprovalGetByIdError = (error: any) => action(ProjectApprovalAction.GET_BY_ID_ERROR, error);
...
export const projectApprovalPostError = (error: any) => action(ProjectApprovalAction.POST_ERROR, error);
