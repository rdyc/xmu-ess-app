...
export const purposeGetAllError = (message: string) => action(PurposeAction.GET_ALL_ERROR, message);
...
export const purposeGetListError = (message: string) => action(PurposeAction.GET_LIST_ERROR, message);
...
export const purposeGetByIdError = (message: string) => action(PurposeAction.GET_BY_ID_ERROR, message);
