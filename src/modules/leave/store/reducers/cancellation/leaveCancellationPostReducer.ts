...
const initialState: IQuerySingleState<ILeaveCancellationPostRequest, ILeaveRequest> = {
  request: undefined,
  response: undefined,
  isError: false,
  isLoading: false,
...
const reducer: Reducer<IQuerySingleState<ILeaveCancellationPostRequest, ILeaveRequest>> = (state = initialState, action) => {
  switch (action.type) {
