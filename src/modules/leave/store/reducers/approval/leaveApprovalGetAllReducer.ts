...
const initialState: IQueryCollectionState<ILeaveApprovalGetAllRequest, ILeave> = {
  request: undefined,
  response: undefined,
  isError: false,
  isLoading: false,
...
const reducer: Reducer<IQueryCollectionState<ILeaveApprovalGetAllRequest, ILeave>> = (state = initialState, action) => {
  switch (action.type) {
