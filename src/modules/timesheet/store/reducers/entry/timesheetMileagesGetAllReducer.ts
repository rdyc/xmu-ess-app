...
import { TimesheetMileagesAction as Action } from '@timesheet/store/actions';
import { Reducer } from 'redux';

const initialState: IQueryCollectionState<ITimesheetMileagesGetAllRequest, ITimesheetMileages> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQueryCollectionState<ITimesheetMileagesGetAllRequest, ITimesheetMileages>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as timesheetMileagesGetAllReducer };