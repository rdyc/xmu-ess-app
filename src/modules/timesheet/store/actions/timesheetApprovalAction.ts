...
export const timesheetApprovalGetAllError = (error: any) => action(TimesheetApprovalAction.GET_ALL_ERROR, error);
...
export const timesheetApprovalGetByIdError = (error: any) => action(TimesheetApprovalAction.GET_BY_ID_ERROR, error);
...
export const timesheetApprovalPostError = (error: any) => action(TimesheetApprovalAction.POST_ERROR, error);
...
export const timesheetApprovalPostBulkError = (error: any) => action(TimesheetApprovalAction.POST_BULK_ERROR, error);
