...
import { ITimesheetApprovalHistoryListFilterResult, TimesheetApprovalHistoryListFilter } from './TimesheetApprovalHistoryListFilter';
...
const stateUpdaters: StateUpdaters<AllProps, IOwnState, IOwnStateUpdater> = {
  ...
  setFilterApplied: (state: IOwnState) => (filter: ITimesheetApprovalHistoryListFilterResult) => ({
    ...filter,
    isFilterOpen: false
  }),
};
...
const handlerCreators: HandleCreators<AllProps, IOwnHandler> = {
  ...
  handleFilterApplied: (props: AllProps) => (filter: ITimesheetApprovalHistoryListFilterResult) => {
  ...
  componentDidMount() {
    ...
    const config: IListConfig<ITimesheet> = {
      ...
      page: {
        ...
        title: this.props.intl.formatMessage(timesheetMessage.approval.page2.listTitle),
        description: this.props.intl.formatMessage(timesheetMessage.approval.page2.listSubHeader)
      },
      ...
      actionComponent: (item: ITimesheet, callback: ListHandler) => (
        <React.Fragment>
          <Button
            size="small"
            onClick={() => this.props.history.push(`/timesheet/approvals/history/${item.uid}`)}
          >
