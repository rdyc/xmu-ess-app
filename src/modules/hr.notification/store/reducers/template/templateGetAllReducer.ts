...
import { ITemplateGetAllRequest } from '@hr.notification/classes/queries/template';
...
const initialState: IQueryCollectionState<ITemplateGetAllRequest, ITemplate> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQueryCollectionState<ITemplateGetAllRequest, ITemplate>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as templateGetAllReducer };