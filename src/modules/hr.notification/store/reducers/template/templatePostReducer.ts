...
import { ITemplatePostRequest } from '@hr.notification/classes/queries/template';
...
const initialState: IQuerySingleState<ITemplatePostRequest, ITemplate> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQuerySingleState<ITemplatePostRequest, ITemplate>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as templatePostReducer };