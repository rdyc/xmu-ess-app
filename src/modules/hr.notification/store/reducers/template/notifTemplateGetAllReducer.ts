...
import { INotifTemplateGetAllRequest } from '@hr.notification/classes/queries/template';
...
const initialState: IQueryCollectionState<INotifTemplateGetAllRequest, INotifTemplate> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQueryCollectionState<INotifTemplateGetAllRequest, INotifTemplate>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as notifTemplateGetAllReducer };