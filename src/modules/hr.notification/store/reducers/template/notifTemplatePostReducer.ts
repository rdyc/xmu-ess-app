...
import { INotifTemplatePostRequest } from '@hr.notification/classes/queries/template';
...
const initialState: IQuerySingleState<INotifTemplatePostRequest, INotifTemplate> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQuerySingleState<INotifTemplatePostRequest, INotifTemplate>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as notifTemplatePostReducer };