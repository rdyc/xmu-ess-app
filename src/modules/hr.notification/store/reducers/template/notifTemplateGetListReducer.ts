...
const initialState: IQueryCollectionState<INotifTemplateGetListRequest, INotifTemplate> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQueryCollectionState<INotifTemplateGetListRequest, INotifTemplate>> = (state = initialState, action) => {
  switch (action.type) {
