...
import { ISettingGetAllRequest } from '@hr.notification/classes/queries/setting';
...
const initialState: IQueryCollectionState<ISettingGetAllRequest, ISetting> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQueryCollectionState<ISettingGetAllRequest, ISetting>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as settingGetAllReducer };