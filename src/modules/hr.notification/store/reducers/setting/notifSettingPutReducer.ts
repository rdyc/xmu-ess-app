...
import { INotifSettingPutRequest } from '@hr.notification/classes/queries/setting';
...
const initialState: IQuerySingleState<INotifSettingPutRequest, INotifSetting> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQuerySingleState<INotifSettingPutRequest, INotifSetting>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as notifSettingPutReducer };