...
import { IPeriodGetAllRequest } from '@hr.notification/classes/queries/period';
...
const initialState: IQueryCollectionState<IPeriodGetAllRequest, IPeriod> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQueryCollectionState<IPeriodGetAllRequest, IPeriod>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as periodGetAllReducer };