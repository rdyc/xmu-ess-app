...
import { INotifPeriodGetAllRequest } from '@hr.notification/classes/queries/period';
...
const initialState: IQueryCollectionState<INotifPeriodGetAllRequest, INotifPeriod> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQueryCollectionState<INotifPeriodGetAllRequest, INotifPeriod>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as notifPeriodGetAllReducer };