...
import { INotifPeriodPutRequest } from '@hr.notification/classes/queries/period';
...
const initialState: IQuerySingleState<INotifPeriodPutRequest, INotifPeriod> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQuerySingleState<INotifPeriodPutRequest, INotifPeriod>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as notifPeriodPutReducer };