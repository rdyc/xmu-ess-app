import { IEmployeeByIdRequest } from '@account/interfaces/queries';
import { IEmployeeDetail } from '@account/interfaces/response';
import { EmployeeAction as Action } from '@account/store/actions';
import { IQuerySingleState } from '@generic/interfaces';
import { Reducer } from 'redux';

const initialState: IQuerySingleState<IEmployeeByIdRequest, IEmployeeDetail> = {
  request: undefined,
  response: undefined,
  isError: false,
  isLoading: false,
...
const reducer: Reducer<IQuerySingleState<IEmployeeByIdRequest, IEmployeeDetail>> = (state = initialState, action) => {
  switch (action.type) {
