import { IEmployeeAccessDeleteRequest } from '@account/classes/queries/employeeAccess';
import { AccountEmployeeAccessAction as Action } from '@account/store/actions';
import { IQuerySingleState } from '@generic/interfaces';
import { Reducer } from 'redux';

const initialState: IQuerySingleState<IEmployeeAccessDeleteRequest, boolean> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQuerySingleState<IEmployeeAccessDeleteRequest, boolean>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as accountEmployeeAccessDeleteReducer };