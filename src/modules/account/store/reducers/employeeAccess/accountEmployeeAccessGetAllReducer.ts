import { IEmployeeAccessGetAllRequest } from '@account/classes/queries';
import { IEmployeeAccess } from '@account/classes/response';
import { AccountEmployeeAccessAction as Action } from '@account/store/actions';
import { IQueryCollectionState } from '@generic/interfaces';
import { Reducer } from 'redux';

const initialState: IQueryCollectionState<IEmployeeAccessGetAllRequest, IEmployeeAccess> = {
  request: undefined,
  response: undefined,
  isError: false,
  isLoading: false,
...
const reducer: Reducer<IQueryCollectionState<IEmployeeAccessGetAllRequest, IEmployeeAccess>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as accountEmployeeAccessGetAllReducer };