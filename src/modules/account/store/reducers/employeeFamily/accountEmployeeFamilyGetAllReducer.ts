import { IEmployeeFamilyAllRequest } from '@account/classes/queries/employeeFamily';
...
const initialState: IQueryCollectionState<IEmployeeFamilyAllRequest, IEmployeeFamily> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQueryCollectionState<IEmployeeFamilyAllRequest, IEmployeeFamily>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as accountEmployeeFamilyGetAllReducer };