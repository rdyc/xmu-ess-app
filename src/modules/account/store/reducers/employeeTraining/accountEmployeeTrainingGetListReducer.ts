import { IEmployeeTrainingListRequest } from '@account/classes/queries/employeeTraining';
...
const initialState: IQueryCollectionState<IEmployeeTrainingListRequest, IEmployeeTrainingList> = {
  request: undefined,
  response: undefined,
  isError: false,
  isLoading: false,
...
const reducer: Reducer<IQueryCollectionState<IEmployeeTrainingListRequest, IEmployeeTrainingList>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as accountEmployeeTrainingGetListReducer };