import { IEmployeeTrainingByIdRequest } from '@account/classes/queries/employeeTraining';
...
const initialState: IQuerySingleState<IEmployeeTrainingByIdRequest, IEmployeeTraining> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQuerySingleState<IEmployeeTrainingByIdRequest, IEmployeeTraining>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as accountEmployeeTrainingGetByIdReducer };