import { IEmployeeTrainingAllRequest } from '@account/classes/queries/employeeTraining';
...
const initialState: IQueryCollectionState<IEmployeeTrainingAllRequest, IEmployeeTraining> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQueryCollectionState<IEmployeeTrainingAllRequest, IEmployeeTraining>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as accountEmployeeTrainingGetAllReducer };