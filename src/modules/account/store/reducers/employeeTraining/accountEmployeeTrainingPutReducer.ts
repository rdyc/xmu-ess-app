import { IEmployeeTrainingPutRequest } from '@account/classes/queries/employeeTraining';
...
const initialState: IQuerySingleState<IEmployeeTrainingPutRequest, IEmployeeTraining> = {
  request: undefined,
  response: undefined,
  isError: false,
  isLoading: false,
...
const reducer: Reducer<IQuerySingleState<IEmployeeTrainingPutRequest, IEmployeeTraining>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as accountEmployeeTrainingPutReducer };