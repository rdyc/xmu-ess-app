import { IEmployeeRateListRequest } from '@account/classes/queries/employeeRate';
import { IEmployeeRateList } from '@account/classes/response/employeeRate';
import { AccountEmployeeRateAction as Action } from '@account/store/actions';
import { IQueryCollectionState } from '@generic/interfaces';
import { Reducer } from 'redux';

const initialState: IQueryCollectionState<IEmployeeRateListRequest, IEmployeeRateList> = {
  request: undefined,
  response: undefined,
  isError: false,
  isLoading: false,
...
const reducer: Reducer<IQueryCollectionState<IEmployeeRateListRequest, IEmployeeRateList>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as accountEmployeeRateGetListReducer };