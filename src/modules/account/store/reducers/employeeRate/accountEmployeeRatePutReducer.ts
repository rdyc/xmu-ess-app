import { IEmployeeRatePutRequest } from '@account/classes/queries/employeeRate';
...
const initialState: IQuerySingleState<IEmployeeRatePutRequest, IEmployeeRate> = {
  request: undefined,
  response: undefined,
  isError: false,
  isLoading: false,
...
const reducer: Reducer<IQuerySingleState<IEmployeeRatePutRequest, IEmployeeRate>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as accountEmployeeRatePutReducer };