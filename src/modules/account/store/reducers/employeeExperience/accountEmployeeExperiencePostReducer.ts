import { IEmployeeExperiencePostRequest } from '@account/classes/queries/employeeExperience';
...
const initialState: IQuerySingleState<IEmployeeExperiencePostRequest, IEmployeeExperience> = {
  request: undefined,
  response: undefined,
  isError: false,
  isLoading: false,
...
const reducer: Reducer<IQuerySingleState<IEmployeeExperiencePostRequest, IEmployeeExperience>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as accountEmployeeExperiencePostReducer };