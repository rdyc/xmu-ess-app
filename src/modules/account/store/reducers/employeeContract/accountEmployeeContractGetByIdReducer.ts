import { IEmployeeContractByIdRequest } from '@account/classes/queries/employeeContract';
import { IEmployeeContractDetail } from '@account/classes/response/employeeContract';
import { AccountEmployeeContractAction as Action } from '@account/store/actions';
import { IQuerySingleState } from '@generic/interfaces';
import { Reducer } from 'redux';

const initialState: IQuerySingleState<IEmployeeContractByIdRequest, IEmployeeContractDetail> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQuerySingleState<IEmployeeContractByIdRequest, IEmployeeContractDetail>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as accountEmployeeContractGetByIdReducer };