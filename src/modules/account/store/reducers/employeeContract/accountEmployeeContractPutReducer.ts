import { IEmployeeContractPutRequest } from '@account/classes/queries/employeeContract';
...
const initialState: IQuerySingleState<IEmployeeContractPutRequest, IEmployeeContract> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQuerySingleState<IEmployeeContractPutRequest, IEmployeeContract>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as accountEmployeeContractPutReducer };