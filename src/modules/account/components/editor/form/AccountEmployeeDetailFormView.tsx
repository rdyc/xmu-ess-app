...
import { AccountEmployeeDetailFormProps } from './AccountEmployeeDetailForm';

export const AccountEmployeeDetailFormView: React.SFC<AccountEmployeeDetailFormProps> = props => {
