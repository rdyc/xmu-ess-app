...
const accountEmployeeRateSummary: React.SFC<AllProps> = props => (
  <Grid container>
...
export const AccountEmployeeRateSummary = compose<AllProps, IOwnProps>(injectIntl)(accountEmployeeRateSummary);