...
const accountEmployeeAccessSummary: React.SFC<AllProps> = props => (
  <Grid container>
    ...
    <Grid item xs={12} sm={6} md={3}>
      ...
      <TextField
        ...
        value={props.data.role && props.data.role.name || 'N/A'}
      />
      <TextField
        {...GlobalStyle.TextField.ReadOnly}
        margin="dense"
...
export const AccountEmployeeAccessSummary = compose<AllProps, IOwnProps>(injectIntl)(accountEmployeeAccessSummary);