...
const accountEmployeeAccessInformation: React.SFC<AllProps> = props => {
  const { data, intl } = props;

  const render = (
    <Card square>
      <CardHeader 
        title={intl.formatMessage(accountMessage.shared.field.titleInformation, {state: 'Access'})}
      />
      <CardContent>
        <TextField 
...
export const AccountEmployeeAccessInformation = compose<AllProps, IOwnProps>(injectIntl)(accountEmployeeAccessInformation);