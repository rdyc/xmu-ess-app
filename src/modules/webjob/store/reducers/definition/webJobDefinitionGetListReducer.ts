...
import { IWebJobDefinitionGetListRequest } from '@webjob/classes/queries';
...
const initialState: IQueryCollectionState<IWebJobDefinitionGetListRequest, IWebJobDefinitionList> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQueryCollectionState<IWebJobDefinitionGetListRequest, IWebJobDefinitionList>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as webJobDefinitionGetListReducer };