...
import { IWebJobDefinitionGetAllRequest } from '@webjob/classes/queries';
...
const initialState: IQueryCollectionState<IWebJobDefinitionGetAllRequest, IWebJobDefinition> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQueryCollectionState<IWebJobDefinitionGetAllRequest, IWebJobDefinition>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as webJobDefinitionGetAllReducer };