...
import { IWebJobRecurringGetAllRequest } from '@webjob/classes/queries';
...
const initialState: IQueryCollectionState<IWebJobRecurringGetAllRequest, IWebJobRecurring> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQueryCollectionState<IWebJobRecurringGetAllRequest, IWebJobRecurring>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as webJobRecurringGetAllReducer };