...
import { IWebJobRecurringDeleteRequest } from '@webjob/classes/queries';
import { WebJobRecurringAction as Action } from '@webjob/store/actions';
import { Reducer } from 'redux';

const initialState: IQuerySingleState<IWebJobRecurringDeleteRequest, boolean> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQuerySingleState<IWebJobRecurringDeleteRequest, boolean>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as webJobRecurringDeleteReducer };