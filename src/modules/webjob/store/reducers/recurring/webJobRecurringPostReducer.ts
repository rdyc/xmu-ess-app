...
import { IWebJobRecurringPostRequest } from '@webjob/classes/queries';
...
const initialState: IQuerySingleState<IWebJobRecurringPostRequest, IWebJobRecurring> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQuerySingleState<IWebJobRecurringPostRequest, IWebJobRecurring>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as webJobRecurringPostReducer };