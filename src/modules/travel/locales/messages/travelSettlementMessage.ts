...
const prefix = 'travel.settlement';

export const travelSettlementPage = defineMessages({
...
// confimation
export const travelSettlementConfirm = defineMessages({
...
// fields
export const travelSettlementField = defineMessages({
  // registration
...
// message
export const travelSettlementMessage = defineMessages({
