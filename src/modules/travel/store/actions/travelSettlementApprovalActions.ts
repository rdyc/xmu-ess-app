...
export const travelSettlementApprovalGetByIdSuccess = (response: IResponseSingle<ITravelSettlementRequestDetail>) => action(TravelSettlementApprovalAction.GET_BY_ID_SUCCESS, response);
