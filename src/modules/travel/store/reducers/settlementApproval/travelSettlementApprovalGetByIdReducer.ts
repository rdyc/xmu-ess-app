...
const initialState: IQuerySingleState<ITravelSettlementApprovalGetByIdRequest, ITravelSettlementRequestDetail> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQuerySingleState<ITravelSettlementApprovalGetByIdRequest, ITravelSettlementRequestDetail>> = (state = initialState, action) => {
  switch (action.type) {
