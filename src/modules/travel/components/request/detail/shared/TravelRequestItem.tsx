...
const TravelRequestItemView: React.SFC<AllProps> = props => (
  <Card square>
    <CardHeader
...
export const TravelRequestItem = compose<AllProps, IOwnProps>(
  setDisplayName('TravelRequestItem'),
  withStateHandlers(createProps, stateUpdaters),
  withStyles(styles),
  injectIntl
)(TravelRequestItemView);