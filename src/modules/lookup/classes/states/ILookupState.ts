...
import { ICustomerAllRequest, ICustomerByIdRequest, ICustomerListRequest, IMenuGetAllRequest, IMenuGetByIdRequest, IMenuListRequest, IPositionGetAllRequest, IPositionGetByIdRequest, IPositionListRequest } from '@lookup/classes/queries';
