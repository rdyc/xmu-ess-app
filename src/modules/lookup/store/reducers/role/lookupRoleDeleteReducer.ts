...
import { ILookupRoleDeleteRequest } from '@lookup/classes/queries/role';
import { LookupCustomerAction as Action } from '@lookup/store/actions';
import { Reducer } from 'redux';

const initialState: IQuerySingleState<ILookupRoleDeleteRequest, boolean> = {
  request: undefined,
  response: undefined,
  isError: false,
  isLoading: false,
...
const reducer: Reducer<IQuerySingleState<ILookupRoleDeleteRequest, boolean>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as lookupRoleDeleteReducer };