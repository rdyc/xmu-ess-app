...
const initialState: IQueryCollectionState<ILeaveAllRequest, ILeave> = {
  request: undefined,
  response: undefined,
  isError: false,
  isLoading: false,
...
const reducer: Reducer<IQueryCollectionState<ILeaveAllRequest, ILeave>> = (state = initialState, action) => {
  switch (action.type) {
