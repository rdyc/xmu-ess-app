...
import { ILookupMileageExceptionByIdRequest } from '@lookup/classes/queries/mileageException';
...
const initialState: IQuerySingleState<ILookupMileageExceptionByIdRequest, IMileageExceptionDetail> = {
  request: undefined,
  response: undefined,
  isError: false,
  isLoading: false,
...
const reducer: Reducer<IQuerySingleState<ILookupMileageExceptionByIdRequest, IMileageExceptionDetail>> = (state = initialState, action) => {
  switch (action.type) {
