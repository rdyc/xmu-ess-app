...
import { ILookupMileageExceptionAllRequest } from '@lookup/classes/queries/mileageException';
...
const initialState: IQueryCollectionState<ILookupMileageExceptionAllRequest, IMileageException> = {
  request: undefined,
  response: undefined,
  isError: false,
  isLoading: false,
...
const reducer: Reducer<IQueryCollectionState<ILookupMileageExceptionAllRequest, IMileageException>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as lookupMileageExceptionGetAllReducer };