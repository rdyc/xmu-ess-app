...
const initialState: IQueryCollectionState<IMileageExceptionAllRequest, IMileageException> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQueryCollectionState<IMileageExceptionAllRequest, IMileageException>> = (state = initialState, action) => {
  switch (action.type) {
