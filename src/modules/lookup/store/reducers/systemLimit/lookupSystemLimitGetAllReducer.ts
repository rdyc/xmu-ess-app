...
const initialState: IQueryCollectionState<ISystemLimitAllRequest, ISystemLimit> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQueryCollectionState<ISystemLimitAllRequest, ISystemLimit>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as lookupSystemLimitGetAllReducer };