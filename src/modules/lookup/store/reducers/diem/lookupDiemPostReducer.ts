...
const initialState: IQuerySingleState<ILookupDiemPostRequest, IDiem> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQuerySingleState<ILookupDiemPostRequest, IDiem>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as lookupDiemPostReducer };