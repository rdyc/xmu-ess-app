...
import { IEmployeeLevelGetDetailRequest } from '@lookup/classes/queries';
...
const initialState: IQuerySingleState<IEmployeeLevelGetDetailRequest, IEmployeeLevelDetail> = {
  isExpired: false,
  isError: false,
  isLoading: false,
  request: undefined,
...
const reducer: Reducer<IQuerySingleState<IEmployeeLevelGetDetailRequest, IEmployeeLevelDetail>> = (state = initialState, action) => {
  switch (action.type) {
...
export { reducer as lookupEmployeeLevelGetByIdReducer };