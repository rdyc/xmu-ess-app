...
export const lookupCompanyPostError = (message: string) => action(LookupCompanyAction.POST_ERROR, message);
...
export const lookupCompanyPutError = (message: string) => action(LookupCompanyAction.PUT_ERROR, message);
...
export const lookupCompanyDeleteError = (message: string) => action(LookupCompanyAction.DELETE_ERROR, message);
