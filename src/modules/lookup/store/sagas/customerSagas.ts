...
function* watchFetchAllRequest() {
  ...
  yield takeEvery(CustomerAction.GET_ALL_REQUEST, worker);
}
...
function* watchFetchListRequest() {
  ...
  yield takeEvery(CustomerAction.GET_LIST_REQUEST, worker);
}
...
function* watchFetchByIdRequest() {
  ...
  yield takeEvery(CustomerAction.GET_BY_ID_REQUEST, worker);
}
