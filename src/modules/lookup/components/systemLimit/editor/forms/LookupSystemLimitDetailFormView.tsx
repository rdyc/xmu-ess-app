...
import { SystemLimitDetailFormProps } from './LookupSystemLimitDetailForm';

export const LookupSystemLimitDetailFormView: React.SFC<SystemLimitDetailFormProps> = props => {
