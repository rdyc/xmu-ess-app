...
import { LookupCustomerListFilterProps } from './LookupCustomerListFilter';

export const LookupCustomerListFilterView: React.SFC<LookupCustomerListFilterProps> = props => (
  <React.Fragment>
    <Dialog
      fullScreen
