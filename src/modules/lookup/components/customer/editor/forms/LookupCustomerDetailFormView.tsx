...
export const LookupCustomerDetailFormView: React.SFC<LookupCustomerDetailFormProps> = props => {
  ...
  const render = (
    <Card square>
      <CardHeader 
        title={intl.formatMessage(lookupMessage.customer.section.infoTitle)}
