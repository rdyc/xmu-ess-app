...
import { CurrencyList } from '@lookup/components/list';
...
class CurrencyListView extends React.Component<AllProps> {
  state = {
...
const redux = connect(mapStateToProps, mapDispatchToProps)(CurrencyListView);
